      ...
      >
        <div>
          ...
          <div className="myCarousel">
            ...
            <h4>Chiang Mai, Thailand, Asia</h4>
            <p>
        ...
        <div>
          ...
          <h3>Friday, March 5th, 2021</h3>
            <h4>Cape Town, South Africa, Africa</h4>
            <p>
        ...
        <div>
          ...
          <div className="myCarousel">
            ...
            <h4>Amsterdam, Netherlands, Europe</h4>
            <p>
              There is no smell sweeter than a field of freshly bloomed tulips nestled in the dutch countryside...
            </p>
          </div>
        </div>
        </Carousel>
